...
public class OkHttpClientManager
{
     ...
     * @throws IOException
     */
    private void _setBackGround(final View view, final String url, final int errorResId)
    {
        final Request request = new Request.Builder()
                .url(url)
                .build();
    ...
    public static void setBackGround(final View view, String url)
    {
        getInstance()._setBackGround(view, url, -1);
    }
